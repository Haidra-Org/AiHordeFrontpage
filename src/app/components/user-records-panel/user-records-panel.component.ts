      ...
      <div class="records-section-wrapper" aria-busy="true">
        @for (i of [1, 2]; track i) {
          <div class="record-group">
            <div class="skeleton-bar" style="width: 8rem; height: 1rem; margin-bottom: 0.75rem;"></div>
            <div class="data-grid-1-2">
              ...
              <div class="data-item-box">
                <span class="skeleton-bar" style="width: 50%; height: 0.75rem;"></span>
                <span class="skeleton-bar" style="width: 35%; height: 1.25rem; margin-top: 0.5rem;"></span>
              </div>
            </div>
          </div>
        }
        ...
        <div class="record-group">
          ...
          <div class="data-grid-1-2-3">
            ...
            @if (data().records!.request!.text !== undefined) {
              <div
                class="data-item-box data-item-centered domain-tint--text"
              >
                <span class="data-label">{{
      ...
      @if (data().records?.fulfillment) {
        <div class="record-group">
          ...
          <div class="data-grid-1-2-3">
            ...
            @if (
              data().records!.fulfillment!.interrogation !== undefined
            ) {
              <div
                class="data-item-box data-item-centered domain-tint--alchemy"
              >
